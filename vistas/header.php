          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  Jesus Alfredo Castillo -Desarrolloador Web
...
if ($_SESSION['consultav']==1) {
  echo '<li class="treeview">
        ...
        <li><a href="https://www.deemsa.com.mx/"><i class="fa fa-question-circle"></i> <span>Ayuda</span><small class="label pull-right bg-yellow">PDF</small></a></li>
